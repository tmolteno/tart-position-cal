...
Applying IRLS with Tukey weights to the UNAM data reduced the inter-antenna residual statistics: median absolute deviation from 0.57~mm to 0.51~mm, standard deviation from 1.07~mm to 1.10~mm, 50th percentile from 0.57~mm to 0.51~mm, and 90th percentile from 1.53~mm to 1.50~mm. The outer loop converged in 10 iterations. Figure~\ref{fig:irls_residuals} shows the residual histogram for the IRLS calibration. Compared to the manual iterative re-measurement workflow, IRLS provides a fully automated path to a robust solution, though manual verification of flagged outlier pairs remains advisable for critical deployments.
